...
class LibraryFilePreviewView extends StatefulWidget {
  ...
  @override
  State<LibraryFilePreviewView> createState() => LibraryFilePreviewViewState();
}

class LibraryFilePreviewViewState extends State<LibraryFilePreviewView> {
  ...
  Widget _buildPlayer() {
    ...
    if (fileType == 'video' || fileType == 'audio') {
      return VideoPreview(videoPath: widget.file.path!);

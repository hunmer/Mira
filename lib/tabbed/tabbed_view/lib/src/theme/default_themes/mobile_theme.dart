...
import 'package:mira/tabbed/tabbed_view/lib/src/theme/equal_heights.dart';
  ...
  static TabThemeData tabTheme({
    ...
    return TabThemeData(
      ...
      highlightedStatus: TabStatusThemeData(
        innerBottomBorder: BorderSide(color: borderColor, width: borderHeight),
      ),
      selectedStatus: TabStatusThemeData(
        innerBottomBorder: BorderSide(color: accentColor, width: borderHeight),
      ),
    );
  }
